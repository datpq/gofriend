        ...
        public TestModel()
        {
            ...
            Messages.Insert(0,
                new ChatMessage
                {
                    ...
                    OwnerName = "Duong Vu",
                    Time = new DateTime(2020, 04, 12, 17, 06, 00),
                    OwnerId = 3,
                    IsOwnMessage = false,
                    LogoUrl = "https://graph.facebook.com/2959609917385257/picture?type=small"
                });
            Messages.Insert(0,
                new ChatMessage
                {
                    Message = "- Vậy khi nào chúng ta sẽ có một CEO thực sự?" +
                              "Cảm xúc của Ben khi đó? Câm nín! Trong một cuộc họp với những nhân vật có ảnh hưởng, Ben được coi là 'fake CEO' ngay trước mặt chính nhân viên của mình và sẽ đến lúc công ty cần thuê một người khác. Đơn giản chỉ vì anh là Engineering founder, và không được coi là người phù hợp dẫn dắt công ty.",
                    OwnerName = "Duong Vu",
                    Time = new DateTime(2020, 04, 12, 17, 06, 10),
                    OwnerId = 3,
                    IsOwnMessage = true,
                    LogoUrl = "https://graph.facebook.com/2959609917385257/picture?type=small"
                });
            Messages.Insert(0,
                new ChatMessage
                {
                    ...
                    OwnerName = "Bảo Anh Bảo Linh Bảo Châu",
                    Time = new DateTime(2020, 04, 12, 17, 07, 00),
                    OwnerId = 1,
                    IsOwnMessage = true,
                    LogoUrl = "https://graph.facebook.com/10217327271725297/picture?type=small"
                });
            Messages.Insert(0,
                new ChatMessage
                {
                    ...
                    OwnerName = "Minh",
                    Time = new DateTime(2020, 04, 12, 17, 09, 00),
                    OwnerId = 5,
                    IsOwnMessage = false,
            ...
            Messages.Insert(0,
                new ChatMessage
                {
                    Message = "- Vậy khi nào chúng ta sẽ có một CEO thực sự?" +
                              "Cảm xúc của Ben khi đó? Câm nín! Trong một cuộc họp với những nhân vật có ảnh hưởng, Ben được coi là 'fake CEO' ngay trước mặt chính nhân viên của mình và sẽ đến lúc công ty cần thuê một người khác. Đơn giản chỉ vì anh là Engineering founder, và không được coi là người phù hợp dẫn dắt công ty.",
                    OwnerName = "Duong Vu",
                    Time = new DateTime(2020, 04, 12, 17, 10, 00),
                    OwnerId = 3,
                    IsOwnMessage = false,
                    LogoUrl = "https://graph.facebook.com/2959609917385257/picture?type=small"
                });
            Messages.Insert(0,
                new ChatMessage
                {
                    Message = "- Vậy khi nào chúng ta sẽ có một CEO thực sự?" +
                              "Cảm xúc của Ben khi đó? Câm nín! Trong một cuộc họp với những nhân vật có ảnh hưởng, Ben được coi là 'fake CEO' ngay trước mặt chính nhân viên của mình và sẽ đến lúc công ty cần thuê một người khác. Đơn giản chỉ vì anh là Engineering founder, và không được coi là người phù hợp dẫn dắt công ty.",
                    OwnerName = "Duong Vu",
                    Time = new DateTime(2020, 04, 12, 19, 06, 00),
                    OwnerId = 3,
                    IsOwnMessage = false,
                    LogoUrl = "https://graph.facebook.com/2959609917385257/picture?type=small"
                });
